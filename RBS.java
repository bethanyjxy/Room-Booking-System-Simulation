...
class RBS {
            ...
            for (int i = 0; i < promoList.size(); i++) {
                if (promo.equals(promoList.get(i).getPromoName()))
                    System.out.printf("\nPromo Code added: %s, %d%s Off with Min Spending of $%d",
                            promoList.get(i).getPromoName(), promoList.get(i).getDiscount(), "%",
                            promoList.get(i).getMinSpend());
            }
        } else if (entry == 2) {
            System.out.println(line);
            for (int i = 0; i < promoList.size(); i++) {
        ...
        do {
                    ...
                    for (int i = 0; i < promoList.size(); i++) {
                        ...
                        if (promoName.equals(String.valueOf(promoList.get(i).getPromoName()))) {
                            if (beforePrice >= promoList.get(i).getMinSpend()) {
                                ...
                                System.out.println("\nInvalid, Please spend a min of $" + promoList.get(i).getMinSpend()
                                        + " to use this code");
                                user = 2;
                            }
            ...
            if (valid == 1) {
                ...
                if ((yn == 'y' || yn == 'Y')) {
                    ...
                    bookList.add(new Booking(bookingID, student, roomList.get(num - 1).getName(),
                            roomList.get(num - 1).getCap(),
        ...
        do {
            ...
            for (int i = 0; i < bookList.size(); i++) {
                if (bookID == bookList.get(i).getbookID()) {
                    System.out.println("\nPlease enter in this time slot available, From: "
                            + bookList.get(i).getMinFrom() + " Till: " + bookList.get(i).getMaxTill() + " Max Hours: "
    ...
    private static void printList() {
        ...
        for (int i = 0; i < roomList.size(); i++) {
            ...
            System.out.printf("%-10s %-10s %-10d %-10s %-10s \t %04d \t %04d \n",
                    ...
                    String.valueOf(roomList.get(i).getPrice()) + "/h", roomList.get(i).getFrom(),
                    roomList.get(i).getTill());
        }
        ...
        for (int i = 0; i < bookList.size(); i++) {
            if (student.equals(bookList.get(i).getStuName())) // For student to see (Only that student name)
            {
                System.out.printf("%-10s %-15s %-10s %-10s %-10s %-10s \t %04d \t %04d\n",
                        ...
                        bookList.get(i).getStuName(), bookList.get(i).getName(),
                        String.valueOf(bookList.get(i).getCap()),
             ...
             * {
             * System.out.printf("%-10s %-10s",String.valueOf(i+1+"."),
    ...
    public static void printReciept(int hour, String promoName, double beforePrice, double discount, int from, int till,
            Boolean gotPromo) {
    ...
    public static void printModify(int beforeHour, int newHour, double roomCost, double paid, double updateNewCost,
            int from, int till) {
        int updateHour = 0;
        double topup = 0.0;
